<div id="flashCarousel" class="carousel slide carousel-fade" data-ride="carousel" data-interval="5000">
        <ol class="carousel-indicators">
            <li data-target="#flashCarousel" data-slide-to="0" class="active"></li>
            <li data-target="#flashCarousel" data-slide-to="1"></li>
            <li data-target="#flashCarousel" data-slide-to="2"></li>
        </ol>
        ...
        <a class="carousel-control-prev" href="#flashCarousel" role="button" data-slide="prev">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" href="#flashCarousel" role="button" data-slide="next">
